      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-slide-up">
          <h2 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">
            Three Ways to <span className="bg-gradient-primary bg-clip-text text-transparent">Earn Money</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card key={index} className="group hover:shadow-medium transition-all duration-300 hover:-translate-y-2 animate-slide-up border-0 shadow-soft bg-gradient-card" style={{animationDelay: `${index * 0.2}s`}}>
              <CardHeader className="text-center pb-4">
                <div className="relative mx-auto mb-6">
                  ...
                  <img
                    ...
                    className="relative w-20 h-20 rounded-2xl mx-auto object-cover shadow-medium"
                  />
                </div>
              ...
              <CardContent className="text-center space-y-4">
                ...
                <div className="bg-accent/10 rounded-lg p-3">
                  <span className="text-accent font-bold text-lg">{feature.earnings}</span>
                </div>
                <Button variant="outline" className="w-full group-hover:shadow-soft transition-all">
                  Get Started
                </Button>
              </CardContent>
            </Card>
