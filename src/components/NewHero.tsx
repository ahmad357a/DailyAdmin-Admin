  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero pt-16">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-32 left-1/4 w-16 h-16 bg-primary-glow rounded-full animate-float" style={{animationDelay: '2s'}}></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-slide-up">
            <h1 className="text-5xl lg:text-7xl font-bold text-primary-foreground mb-6 leading-tight">
              Daily
              <span className="bg-gradient-accent bg-clip-text text-transparent animate-pulse-glow"> Earn</span>
            </h1>
            <p className="text-xl lg:text-2xl text-primary-foreground/90 mb-8 leading-relaxed">
              Turn your daily activities into <span className="text-accent font-semibold">real earnings</span>. 
            ...
            <div className="mt-12 grid grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-primary-foreground/80">Paid Out</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-accent">100+</div>
                <div className="text-primary-foreground/80">Daily Tasks</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-slide-up" style={{animationDelay: '0.3s'}}>
            <div className="relative">
              ...
              />
              <div className="absolute -top-4 -right-4 w-8 h-8 bg-accent rounded-full animate-pulse-glow"></div>
              <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-primary-glow rounded-full animate-float"></div>
            </div>
          </div>
        </div>
      </div>
